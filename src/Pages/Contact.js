          ...
          <div className=" w-11/12 mx-auto mt-32 ">
            <div className="pb-16 flex ">
              ...
              <div className="flex flex-col py-16">
                <div className="text-right  flex ml-16 justify-center border-y-2 p-16 items-center text-2xl">
                ...
                <div className=" border-y-2 p-16 flex ml-16 flex-col justify-center items-start  text-2xl">
